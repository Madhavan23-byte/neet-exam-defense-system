...
The canonical representation is implemented in `app.modules.audit.canonical` using deterministic key-sorted compact JSON serialization following RFC 8785 principles using Python's standard `json` implementation.
